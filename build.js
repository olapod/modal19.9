  ...
  _createClass(User, [{
    ...
    value: function render() {
      return React.createElement(
        "div",
        { className: "user" },
        React.createElement("img", { className: "avatar", src: this.props.user.avatar_url, style: { maxWidth: '250px' } }),
        React.createElement(
          "a",
          { className: "user_name", href: this.props.user.html_url, target: "_blank" },
